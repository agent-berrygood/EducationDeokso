...
export default function KinderPage() {
  ...
  const { phase, tracks, config: trackConfig, selectTrack } = useDepartmentTrackConfig('kinder');
  ...
  if (phase === 'ready' && trackConfig && trackConfig.isCampActive === false) {
    return (
      <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center text-center px-6 space-y-4">
        ...
        <h1 className="text-2xl font-bold text-gray-800">나우킨더는 올해 수련회를 진행하지 않습니다</h1>
